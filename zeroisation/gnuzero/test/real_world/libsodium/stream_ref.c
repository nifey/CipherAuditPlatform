...
/* END INPUT FROM include/sodium/private/common.h */

/* BEGIN INPUT FROM include/sodium/utils.h */

extern void SCRUBBER_ATTR sodium_memzero(void * const pnt, const size_t len);

/* END INPUT FROM include/sodium/utils.h */
...
{
    struct chacha_ctx SCRUB_ATTR ctx;
